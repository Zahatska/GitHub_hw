...
if (age_1 < age_2) {
  console.log(
    "You do not have access cause your age is " + age_1 + " It is less then"
  );
...
const check_age = function (age) {
  if (age < age_2) {
    console.log(
      "You do not have access cause your age is " + age + " It is less then"
    );
...
const check_age2 = function (age) {
  if (typeof age == "number") {
    ...
    console.log("Unexpected symbols. \tPlease enter the number");
  }
};
check_age2(30);
check_age2("fnfkld");
...
const check_age3 = function (age) {
  if (age && !isNaN(age)) {
    //isNaN(Not A Number) retern 'true' when variable is NaN
    if (age < age_2) {
      console.log(
        "You do not have access cause your age is " + age + " It is less then"
      );
